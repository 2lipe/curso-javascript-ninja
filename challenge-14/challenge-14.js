(function() {
  ...
  */
  ...
  var pName = name.reduce(function( x,y ) {
    return (x  + 'p' + y);
  }, '');
  ...
  */
  ...
  var objArr = numberObjects[1];
  var hasObject = numberObjects.indexOf( objArr ) > -1;
  ...
  //Para não usar uma atribuição para se utilizar o indexOf() pode-se usar o some()
  ...
  */
  ...
  var hasObjectReverse = numberObjects.lastIndexOf( objArr ) > -1;
  ...
  */
  ...
  var arrayIsTrue = Array.isArray( justMod2Or3 );
