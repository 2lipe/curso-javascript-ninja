(function() {
  ...
  */
  ...
  var myText = text.replace( /Manuel Marques de Sousa/g, 'Felipe da Silva Vieira' );
  ...
  */
  ...
  var myText = myText.replace( /brasileiro/g, 'capixaba' ) ;
  ...
  */
  ...
  console.log( myText.replace( /\d/g, '-' ) );
  ...
  */
  ...
  console.log( myText.replace(/[D-Hd-h]/g, '0' ) );
  ...
  */
  ...
  console.log( myText.replace(/a/gi, '4' ) );
  ...
  */
  ...
  console.log( myText.replace( /O Centauro de Luvas/g, function( text ) {
  ...
  */
  ...
  console.log( myText.replace( regexDate, replaceDate ) );
